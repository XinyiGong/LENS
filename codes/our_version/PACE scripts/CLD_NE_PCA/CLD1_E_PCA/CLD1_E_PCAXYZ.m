...
path='/nv/hp22/xgong42/scratch/CLD_ENE/E/CLD1_E';
...
% %% PCA
[PC,Var] = PCAConstruct(GG,900);
%[PC,Var] = PCAConstruct(GG,3);
% save PC, Var, rowname

savepath='/nv/hp22/xgong42/scratch/CLD_PCA/CLD_PCA_E/CLD1_E_PCAXYZ';
%savepath='C:\Users\Andrey\Google Drive\MATIN 2015\Data\72_PC_VAR';
save([savepath,'/metadata'],'rowname');
save([savepath,'/CLD1_E_PCAXYZ'],'PC');
save([savepath,'/CLD1_E_PCAXYZ'],'Var','-append');
