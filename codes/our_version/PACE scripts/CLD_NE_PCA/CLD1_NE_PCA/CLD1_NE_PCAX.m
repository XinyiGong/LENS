...
path='/nv/hp22/xgong42/scratch/CLD_ENE/NE/CLD1_NE';
...
savepath='/nv/hp22/xgong42/scratch/CLD_PCA/CLD_PCA_NE/CLD1_NE_PCAX';
%savepath='C:\Users\Andrey\Google Drive\MATIN 2015\Data\72_PC_VAR';
save([savepath,'/metadata'],'rowname');
save([savepath,'/CLD1_NE_PCAX'],'PC');
save([savepath,'/CLD1_NE_PCAX'],'Var','-append');
