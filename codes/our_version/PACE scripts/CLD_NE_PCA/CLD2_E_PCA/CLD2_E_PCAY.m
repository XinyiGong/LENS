...
path='/nv/hp22/xgong42/scratch/CLD_ENE/E/CLD2_E';
...
savepath='/nv/hp22/xgong42/scratch/CLD_PCA/CLD_PCA_E/CLD2_E_PCAY';
%savepath='C:\Users\Andrey\Google Drive\MATIN 2015\Data\72_PC_VAR';
save([savepath,'/metadata'],'rowname');
save([savepath,'/CLD2_E_PCAY'],'PC');
save([savepath,'/CLD2_E_PCAY'],'Var','-append');
